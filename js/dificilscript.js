...
function generarOperacion(divOperacion) {
    ...
    do {
        primerNumero = generarNumeroRandom();
        segundoNumero = generarNumeroRandomMenor(primerNumero);
...
function generarNumeroRandomMenor(numero) {
    return Math.floor(Math.random() * (numero / 2) + 1);
}
