...
function generarOperacion(divOperacion) {
    ...
    do {
        primerNumero = generarNumeroPar();
        segundoNumero = generarNumeroParMenor(primerNumero);
...
function generarNumeroParMenor(numero) {
    return Math.floor(Math.random() * (numero / 2)) * 2 + 2;
}
